...
It:
* inherits all attributes of the [raster image component](raster.md) 
...
The same syntax can be applied as the [raster image component](raster.md) with the addition of the `size` attribute.
