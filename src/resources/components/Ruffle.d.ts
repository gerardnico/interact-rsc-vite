...
export interface Ruffle {
    config: RuffleConfig
}

export interface RufflePlayer extends HTMLElement {
    /**
     * @param url - A string, indicating the SWF file to load (e.g. "movie.swf")
     * @param allowScriptAccess - A boolean indicating whether the file is allowed to interact with the page through JavaScript
     */
    load: (url: string, allowScriptAccess?: boolean) => void;
    ruffle: () => Ruffle
